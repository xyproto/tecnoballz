...
class handler_popup_menu : public virtual display_text_bitmap, public virtual sprite_object {
 private:
 ...
 public:
  ...
  /** String indexes */
  typedef enum { MENU_00, MENU_01 = 4, MAX_OF_LINES = 7 } MENU_TEXTS_ENUM;
