...
class sprite_ball : public sprite_object {
 ...
 public:
  ...
  typedef enum { NORMAL, POWER_1, POWER_2 } TYPES_OF_BALL;
  /** Different sizes of ball */
  typedef enum { SIZE_1 = 0, SIZE_2 = 3, SIZE_3 = 6 } SIZES_OF_BALL;
 ...
 private:
  ...
  /** Pointer to the sprite of the ejector */
  sprite_ejector* ejector;
 ...
 public:
  ...
  void once_init(Sint32 start, Sint32 speed, sprite_paddle* paddle, Sint16* table, Sint32 w);
