 ...
 * @param grdPt
 */
void controller_guardians::create_guardians_list(Sint32 grdPt) {
  ...
  displacement_curve = (unsigned char*)resources->load_data(handler_resources::RESGCURVES);
  ...
  try {
    ...
    std::cerr << "(!)controller_guardians::create_guardians_list() "
  ...
  for (Uint32 i = 0; i < max_of_sprites; i++) {
    ...
    sprite->create_sprite(sprite_object::LIFE_GAUGE, sprites_bitmap, false);
    sprites->add(sprite);
 ...
 */
void controller_guardians::set_gauge_height() {
 ...
 */
bool controller_guardians::is_guardians_destroyed() {
...
void controller_guardians::killguards(Sint32 numGa) {
  switch (numGa) {
    case 2:
      if (max_of_sprites > 1) {
...
// select curve's gard
//-------------------------------------------------------------------------------
unsigned char* controller_guardians::getLissaPt(Sint32 lissa) {
...
//
//-------------------------------------------------------------------------------
const char controller_guardians::offzetbyte[256] = {
    };

/**
 * Describe guardian levels
 */
gardlevel controller_guardians::guard_list[] = {
...
//-------------------------------------------------------------------------------
Sint32 controller_guardians::level_list[] = {0,  1,  -1,  // area 1
                                             2,  -1,
 ...
 */
Sint32 controller_guardians::level2gdpt(Uint32 area_num, Uint32 level_num) {
  if (area_num < 1) {
    area_num = 1;
  }
  if (level_num < 1) {
  ...
  for (;;) {
    ...
    if (level_list[gdptr + 1] == -1) {
      fprintf(stderr, "controller_guardians::level2gdpt(%i, %i) end of table\n", area_num,
              level_num);
      gdptr = 0;
      break;
    }
