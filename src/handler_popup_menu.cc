 ...
 * Read the texts file
 */
void handler_popup_menu::load_text_file() {
  if (texts_of_menus != NULL) {
    return;
  }
  texts_of_menus =
      resources->load_texts(handler_resources::TEXTS_POPUP_MENU, MAX_OF_LINES, MAX_OF_CHARS, 0);
 ...
 */
void handler_popup_menu::initialize_palette() {
 ...
 */
void handler_popup_menu::first_init(bitmap_data* bmp) {
  load_text_file();
  Uint32 w;
 ...
 */
void handler_popup_menu::build_menu_box(bitmap_data* bmp, Uint32 w) {
 ...
 */
void handler_popup_menu::draw(char* source,
                              Sint32 xcoord,
                              Sint32 ycoord,
                              Sint32 raw_src,
                              Sint32 width,
...
Sint32 handler_popup_menu::run() {
  ...
  if (keyboard->command_is_pressed(handler_keyboard::TOGGLE_POPUP_MENU)) {
    if (!is_enabled) {
      menu_events->start(vertical_space, 1, num_of_lines, menu_xcenter,
 ...
 */
void handler_popup_menu::display_640() {
 ...
 */
void handler_popup_menu::display_320() {
  Sint32 color = menu_first_color_index;
  char* desP1 = pixel_data + char_height + row_size * vertical_space;
  Sint32 offSc = off_source;
  Sint32 offDs = row_size;
...
const unsigned char handler_popup_menu::cycling_table[] = {
    239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255,
    254, 253, 252, 251, 250, 249, 248, 247, 246, 245, 244, 243, 242, 241, 240, 239, 240,
    241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255};

char** handler_popup_menu::menu_texts_pt[2] = {NULL, NULL};
