 ...
 */
tiles_background* tiles_background::get_instance() {
 ...
 * @param tiles_num
 */
void tiles_background::setup(Uint32 tiles_num) {
  if (is_verbose) {
    ...
    case TILES_32x32_WITH_4_COLORS: {
      ...
      if (is_verbose) {
        std::cout << "tiles_background::setup() "
                     "load 32x32 tiles with 4 colors"
                  << std::endl;
      }
      ...
      y >>= 1;
      y = y * tiles_height;
      current_tiles = (bitmap_data*)bmp->cut_to_bitmap(x, y, 5 * tiles_width, tiles_height);
      delete bmp;
    } break;
 ...
 */
void tiles_background::draw_shadows() {
 ...
 * Generate tiles map
 */
void tiles_background::generate_map() {
 ...
 */
void tiles_background::set_scroll_type(Uint32 type) {
  map_scroll_num = type;
  map_scroll_delay = 0;
 ...
 */
void tiles_background::draw(offscreen_surface* offscreen) {
  ...
  Uint32 map_index = (map_ycoord / tiles_height % map_height) * map_height * 2 +
 ...
 */
Sint32 tiles_background::table_pos1[16] = {3, 0, 0, 3, 4, 2, 1, 4, 3, 2, 1, 1, 0, 0, 2, 4};

Sint32 tiles_background::table_pos2[16] = {3, 0, 0, 3, 4, 2, 1, 4, 3, 2, 1, 1, 5, 0, 5, 4};

void tiles_background::set_palette() {
 ...
 */
void tiles_background::set_4_color_palette() {
 ...
 */
void tiles_background::next_4_color_palette() {
  palette_index += 16;
 ...
 */
void tiles_background::prev_4_color_palette() {
  palette_index -= 16;
  if (palette_index < 0) {
    palette_index = 432;
  }
 ...
 */
void tiles_background::set_4_color_palette(Uint32 pal_index) {
  if (is_verbose) {
 ...
 */
unsigned char tiles_background::couleurs[448] = {
    };
