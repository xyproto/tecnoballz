 ...
 */
void sprite_capsule::init_members() {
 ...
 */
void sprite_capsule::enable_indicator_capsule(Uint32 id) {
 ...
 * @param id capsule identifier
 */
void sprite_capsule::enable_capsule(brick_redraw* brick, Uint32 id) {
  set_new_capsule(id, &gagdetBrik[0], brick->xcoord_collision, brick->ycoord_collision,
                  brick->paddle);
}
 ...
 * @param id capsule identifier
 */
void sprite_capsule::enable_capsule(sprite_ball* ball, Uint32 id) {
  set_new_capsule(id, &gagdetBrik[0], ball->get_x_coord(), ball->get_y_coord(),
                  ball->get_last_paddle_touched());
}
...
void sprite_capsule::enable_capsule(sprite_projectile* blast, Uint32 id) {
 ...
 * @param id capsule identifier
 */
void sprite_capsule::enable_guardian_capsule(sprite_ball* ball, Uint32 id) {
  set_new_capsule(id, &gagdetGuar[0], ball->get_x_coord(), ball->get_y_coord(),
                  ball->get_last_paddle_touched());
}
 ...
 */
void sprite_capsule::set_new_capsule(Uint32 id,
                                     const Sint16* frames,
                                     Uint32 xcoord,
                                     Uint32 ycoord,
                                     sprite_paddle* pad) {
  ...
  if (index < 0) {
    std::cerr << "sprite_capsule::set_new_capsule() "
              << "index "
 ...
 */
void sprite_capsule::set_in_shop(Uint32 id) {
 ...
 */
void sprite_capsule::clone_from_capsule(sprite_capsule* capsule) {
 ...
 */
sprite_paddle* sprite_capsule::move() {
  if (!is_enabled) {
    return NULL;
  }
  switch (towards) {
...
const Sint16 sprite_capsule::gagdetBrik[] = {
    ...
    NO_IMAGE, IMAGE_GLUE,
    /* unused */
    NO_IMAGE, IMAGE_FIRE_POWER_1, IMAGE_FIRE_POWER_2, IMAGE_SHRINK_PADDLE, IMAGE_EXPAND_PADDLE,
    IMAGE_LOSE_A_LIFE, IMAGE_EXTRA_LIFE, IMAGE_EXTRA_BALLS, IMAGE_MULTI_BALLS, IMAGE_POWER_BALL_1,
    IMAGE_POWER_BALL_2, IMAGE_INVERSE_CONTROL,
    ...
    NO_IMAGE, IMAGE_BALL_SIZE_2, IMAGE_BALL_SIZE_3, IMAGE_CHANCE, IMAGE_ENABLE_HUGELY_OPTIONS,
    /* set the price to 1 (not capsule) */
    NO_IMAGE, IMAGE_BOTTOM_WALL, IMAGE_ROBOT_PADDLE, IMAGE_BALLS_CONTROL,
...
const Sint16 sprite_capsule::gagdetGuar[] = {
    ...
    NO_IMAGE,
    /* unused */
    NO_IMAGE, IMAGE_PADDLE_INVINCIBILITY,
    /* unused */
    NO_IMAGE,
    /* unused */
    NO_IMAGE,
    ...
    IMAGE_EXTRA_LIFE,
    /* unused */
    NO_IMAGE, IMAGE_MULTI_BALLS, IMAGE_BALL_SIZE_2, IMAGE_BALL_SIZE_3,
    /* unused */
    NO_IMAGE,
    /* unused */
    NO_IMAGE,
