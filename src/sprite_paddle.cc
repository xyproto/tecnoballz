 ...
 */
void sprite_paddle::create_projectiles_list() {
 ...
 */
void sprite_paddle::fire_projectiles() {
 ...
 */
void sprite_paddle::move_projectiles() {
  projectiles->fire();
  projectiles->move();
}
 ...
 */
void sprite_paddle::enable_if_ok(bool is_team, Sint32 size, Uint32 counter) {
  length = size;
  is_enabled = false;
  ...
  if (paddle_number == controller_paddles::BOTTOM_PADDLE ||
      (paddle_number == controller_paddles::LEFT_PADDLE && is_team)) {
    enable_counter = 1;
    is_enabled = true;
  }
  select_image(size);
 ...
 */
void sprite_paddle::set_width(Uint32 size) {
  length = size;
 ...
 */
void sprite_paddle::set_height(Uint32 h) {
  length = h;
 ...
 */
void sprite_paddle::select_image(Uint32 size) {
 ...
 * Select the sprite image of the paddle
 */
void sprite_paddle::select_image() {
  select_image(length);
}
 ...
 */
Uint32 sprite_paddle::get_paddle_number() {
 ...
 */
void sprite_paddle::release_ball() {
 ...
 */
void sprite_paddle::stick_ball(sprite_ball* ball) {
  if (stuck_ball != NULL) {
 ...
 */
Uint32 sprite_paddle::get_length() {
  return length;
}
 ...
 */
bool sprite_paddle::is_invincible() {
 ...
 */
void sprite_paddle::set_invincibility(Sint32 delay) {
