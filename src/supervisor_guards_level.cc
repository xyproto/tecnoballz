 ...
 */
void supervisor_guards_level::first_init() {
  game_screen->clear();
#ifndef SOUNDISOFF
  ...
  balls->init(
      ...
      level_desc->ball_release_time, 0,
  ...
  sprite_playername->set_coordinates(
      (display->get_width() - sprite_playername->get_sprite_width()) / 2, resolution);
 ...
 */
Uint32 supervisor_guards_level::main_loop() {
