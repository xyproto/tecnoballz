 ...
 */
void sprite_display_scores::first_init(Uint32 x_offset) {
  ...
  offscreen_text->create_surface(TEXT_LARGE * width_font, TEXT_HAUTE * space2next);
...
//------------------------------------------------------------------------------
Sint32 sprite_display_scores::displayTxt() {
  //###################################################################
  // display menu text
  //###################################################################
 ...
 */
void sprite_display_scores::copyToText() {
...
// scores table text
//------------------------------------------------------------------------------
char sprite_display_scores::scorestext[] =
    "    TECNOBALL TOP TEN  "   // 0
