 ...
 */
void controller_projectiles::create_projectiles_list(sprite_paddle* paddle) {
  create_sprites_list();
  gun_paddle = paddle;
 ...
 */
void controller_projectiles::disponible() {
 ...
 * New fire start
 */
void controller_projectiles::fire() {
  if (gun_paddle->fire_state != sprite_paddle::NOT_OWN_GUN) {
 ...
 */
void controller_projectiles::init_type1() {
 ...
 */
void controller_projectiles::init_type2() {
  sprite_paddle* paddle = gun_paddle;
  if (paddle->fire_state != sprite_paddle::FIRE) {
    return;
  }
 ...
 */
void controller_projectiles::init_type3() {
  sprite_paddle* paddle = gun_paddle;
  if (paddle->fire_state != sprite_paddle::FIRE) {
    return;
  }
 ...
 */
void controller_projectiles::init_type4() {
  sprite_paddle* paddle = gun_paddle;
  if (paddle->fire_state != sprite_paddle::FIRE) {
    return;
  }
 ...
 */
void controller_projectiles::init_type5() {
  sprite_paddle* paddle = gun_paddle;
  if (paddle->fire_state != sprite_paddle::FIRE) {
    return;
  }
 ...
 */
void controller_projectiles::init_type6() {
  sprite_paddle* paddle = gun_paddle;
  if (paddle->fire_state != sprite_paddle::FIRE) {
    return;
  }
 ...
 */
void controller_projectiles::init_type7() {
  sprite_paddle* paddle = gun_paddle;
 ...
 */
void controller_projectiles::move() {
  Sint32 i = gun_paddle->length;
  paddle_length = i;
 ...
 */
void controller_projectiles::move_type1() {
  sprite_projectile* projectile = sprites_list[0];
  sprite_paddle* paddle = gun_paddle;
 ...
 */
void controller_projectiles::move_type2() {
  sprite_projectile** projectiles = sprites_list;
  sprite_paddle* paddle = gun_paddle;
  Sint32 a = countTempo;
  Sint32 b, c, d;
 ...
 */
void controller_projectiles::move_type3() {
  sprite_projectile** projectiles = sprites_list;
  sprite_paddle* paddle = gun_paddle;
  Sint32 i, j;
  sprite_projectile* projectile;
 ...
 */
void controller_projectiles::move_type4() {
  Sint32 i, j;
  i = countTempo;
  i++;
  if (i > 20) {
...
void controller_projectiles::move_type5() {
  sprite_projectile** projectiles = sprites_list;
  sprite_paddle* paddle = gun_paddle;
 ...
 */
void controller_projectiles::move_type6() {
  Sint32 a, i, j;
 ...
 */
void controller_projectiles::move_type7() {
  sprite_projectile** projectiles = sprites_list;
  sprite_paddle* paddle = gun_paddle;
  for (Sint32 i = 0; i < 7; i++) {
    sprite_projectile* projectile = *(projectiles++);
 ...
 * Enable fire power 1
 */
void controller_projectiles::set_fire_1() {
  sprite_projectile** projectiles = sprites_list;
  for (Uint32 i = 0; i < max_of_sprites; i++) {
    sprite_projectile* projectile = *(projectiles++);
 ...
 * Enable fire power 2
 */
void controller_projectiles::set_fire_2() {
  sprite_projectile** projectiles = sprites_list;
  for (Uint32 i = 0; i < max_of_sprites; i++) {
    sprite_projectile* projectile = *(projectiles++);
 ...
 */
const Sint16 controller_projectiles::circular_sin_640[] = {
    15 * 2,  -3 * 2,  13 * 2,  -7 * 2,  11 * 2,  -10 * 2, 9 * 2,   -12 * 2, 7 * 2,   13 * 2,
    3 * 2,   -15 * 2, 0 * 2,   -15 * 2, -3 * 2,  -15 * 2, -6 * 2,  -14 * 2, -9 * 2,  -12 * 2,
    -11 * 2, -10 * 2, -13 * 2, -07 * 2, -14 * 2, -04 * 2, -15 * 2, -01 * 2, -15 * 2, 3 * 2,
    -13 * 2, 7 * 2,   -11 * 2, 10 * 2,  -9 * 2,  12 * 2,  -7 * 2,  13 * 2,  -3 * 2,  15 * 2,
    0 * 2,   15 * 2,  3 * 2,   15 * 2,  6 * 2,   14 * 2,  9 * 2,   12 * 2,  11 * 2,  10 * 2,
    13 * 2,  7 * 2,   14 * 2,  4 * 2,   15 * 2,  1 * 2,   99,      99,      99,      99};

/**
 * Sinus used for he fire 7 in 320 pixels resolution
 */
const Sint16 controller_projectiles::circular_sin_320[] = {
