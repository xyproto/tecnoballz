 ...
 */
head_animation* head_animation::get_instance() {
 ...
 */
void head_animation::load_bitmap() {
 ...
 */
void head_animation::draw() {
  Uint32 xcoord = frame_index * head_width;
  game_screen->blit_surface(head_bitmap, xcoord, 0, 272 * resolution, 106 * resolution, head_width,
                            head_height);
}
 ...
 */
void head_animation::start_laugh() {
 ...
 */
void head_animation::start_yawn() {
 ...
 */
void head_animation::start_interference() {
