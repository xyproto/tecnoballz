...
void controller_indicators::create_indicators_sprites() {
  create_sprites_list();
 ...
 */
void controller_indicators::init_money() {
 ...
 */
void controller_indicators::display_money_and_reverse() {
 ...
 */
void controller_indicators::display_money_and_lifes() {
  display_money_amount();
 ...
 */
void controller_indicators::display_money_amount() {
 ...
 */
void controller_indicators::increase_money_amount(Uint32 value) {
