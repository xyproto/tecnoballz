...
//------------------------------------------------------------------------------
void display_text_bitmap::initial_me() {
  object_init();
 ...
 */
void display_text_bitmap::destroy_me() {
 ...
 */
void display_text_bitmap::initialize() {
 ...
 */
Uint32 display_text_bitmap::get_char_height() {
  return char_height;
}
 ...
 */
void display_text_bitmap::load_bitmap_fonts(Uint32 resource_id) {
 ...
 */
void display_text_bitmap::draw(offscreen_surface* dest,
                               Uint32 xcoord,
                               Uint32 ycoord,
                               Sint32 value,
                               Uint32 padding) {
 ...
 * @param padding length of the string
 */
void display_text_bitmap::draw(surface_sdl* dest,
                               Uint32 xcoord,
                               Uint32 ycoord,
                               Sint32 value,
                               Uint32 padding) {
...
void display_text_bitmap::draw(surface_sdl* dest,
  ...
  for (Uint32 i = 0; i < length; i++, rect_destination.x += char_width) {
    ...
    if (SDL_BlitSurface(surface_fonts, &rect_fonts, surface_dest, &rect_destination) < 0) {
 ...
 */
void display_text_bitmap::print_to_string(char* src, char* dst, Uint32 length) {
  char* d = strchr(dst, '.');
  if (NULL == d) {
    d = dst;
  }
...
void display_text_bitmap::print_int_to_string(Sint32 value, Sint32 padding, char* dst) {
  char* d = strchr(dst, '.');
  if (NULL == d) {
    d = dst;
  }
...
//------------------------------------------------------------------------------
sprite_object* display_text_bitmap::string2bob(const char* ptStr) {
...
// . = -
//------------------------------------------------------------------------------
char display_text_bitmap::ascii2code[128] = {
    26,  // 32 ' '
    37,  // 33 '!'
    40,  // 34 '"'
    26,  // 35 '#' space
