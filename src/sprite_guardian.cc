 ...
 */
void sprite_guardian::initialize(gardlevel* guard, unsigned char* ptLis) {
  energy_level = guard->para_power * difficulty_level;  // strength
  canon_xcoord = (guard->para_xcent * resolution) -
 ...
 */
void sprite_guardian::run(Uint32 /* voffset */) {
 ...
 * Fire new bullets
 */
void sprite_guardian::fire_bullets() {
 ...
 */
void sprite_guardian::startBlitz() {
...
const Sint32 sprite_guardian::table_gga1[8] = {0, 1, 2, 3, 4, 5, 6, 5};

// Guard of 32/64 pixels
const Sint32 sprite_guardian::table_gga2[8] = {6, 5, 4, 6, 5, 4, 6, 5};
