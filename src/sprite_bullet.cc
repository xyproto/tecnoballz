...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_01() {
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_02() {
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_03() {
  y_coord = y_coord + (4 * resolution);
  screenOver(tir_minixy);
}
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_04() {
  if (flagDepla5) {
    if (--flagDepla4 <= 0) {
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_05() {
  if (flagDepla1 > 0) {
    flagDepla1--;
    y_coord += resolution;
  } else {
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_06() {
  flagDepla3 = flagDepla3 + 2;
  /* end of the table */
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_07() {
  /* update y-coordinate */
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_08() {
  flagDepla3 = flagDepla3 + 2;
  if (flagDepla3 >= 360)
    flagDepla3 = 0;
 ...
 */
void sprite_bullet::trajectory_09() {
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_10() {
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_11() {
  flagDepla3 = flagDepla3 + 4;
  if (flagDepla3 >= 360)
    flagDepla3 -= 360;
...
//------------------------------------------------------------------------------
void sprite_bullet::trajectory_12() {
  flagDepla3 = flagDepla3 + 4;
  if (flagDepla3 >= 360)
    flagDepla3 -= 360;
...
//------------------------------------------------------------------------------
void sprite_bullet::screenOver(Sint32 vmini) {
  if (x_coord > tir_maxi_x || x_coord < vmini || y_coord < vmini || y_coord > tir_maxi_y)
    is_enabled = false;
}
...
// weapons: overflow test
//------------------------------------------------------------------------------
void sprite_bullet::screenStop(Sint32 vmini) {
