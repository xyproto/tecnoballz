 ...
 */
void sprite_projectile::set_power1() {
  frame_index_min = 4;
  frame_index_max = 7;
  frame_index = 4;
 ...
 */
void sprite_projectile::set_power2() {
  frame_index_min = 0;
  frame_index_max = 3;
  frame_index = 0;
 ...
 */
void sprite_projectile::init_members(sprite_paddle* pad) {
  paddle = pad;
  indexSinus = 0;
  fire_Xscie = 0;
  fire_Yscie = 0;
 ...
 */
void sprite_projectile::start_list() {
  total_fire = 0;
 ...
 */
void sprite_projectile::gestionTir() {
  check_outside();
 ...
 */
void sprite_projectile::check_outside() {
 ...
 */
void sprite_projectile::play_projectiles_animations() {
  sprite_projectile** projectiles = projectiles_list;
 ...
 */
void sprite_projectile::check_collisions_with_bricks() {
 ...
 */
void sprite_projectile::check_collisions_with_ships() {
  sprite_projectile** projectiles = projectiles_list;
 ...
 */
void sprite_projectile::disable_sprites() {
  sprite_projectile** projectiles = projectiles_list;
  for (Uint32 i = 0; i < total_fire; i++) {
    sprite_projectile* blast = *(projectiles++);
    blast->is_enabled = false;
