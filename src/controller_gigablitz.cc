...
Uint32 controller_gigablitz::numeroBOBs[MAX_OF_GIGABLITZ] = {
    sprite_object::GIGABLITZ_7, sprite_object::GIGABLITZ_6, sprite_object::GIGABLITZ_5,
    sprite_object::GIGABLITZ_4, sprite_object::GIGABLITZ_3, sprite_object::GIGABLITZ_2,
 ...
 */
void controller_gigablitz::create_gigablitz_sprites() {
 ...
 */
void controller_gigablitz::shoot_paddle() {
 ...
 */
void controller_gigablitz::run_in_bricks_levels() {
 ...
 */
void controller_gigablitz::collision1() {
 ...
 */
void controller_gigablitz::run_in_guardians_level() {
  if (0 == gigablitz_height) {
    return;
  }
  Sint32 y = current_gigablitz->get_y_coord();
 ...
 */
void controller_gigablitz::collision_with_paddle() {
  ...
  if (gy + (Sint32)gigablitz_height < y || gx + gw < x || gx > x + w || gy > y + h) {
    return;
  }
#ifndef SOUNDISOFF
  ...
  explosions->add(x + paddle_bottom->get_length() / 2, y + paddle_bottom->get_sprite_height() / 2);
 ...
 */
bool controller_gigablitz::shoot_guardian(Uint32 id, Sint32 xcoord, Sint32 ycoord, Uint32 width) {
  if (gigablitz_height > 0) {
